	...
	<div class="row">
		<div class="<?php echo $comment_class_sticky_box;?>">
			<div class="category-box sticky-box static_col">
				<h2 style="font-size:30px;"><?php _e("Commentaires", "favethemes"); ?></h2>
			</div>
		</div>
                ...
                <div>
					...
					$fields =  array(
						'author'=> '<div class="form-group col-lg-4 col-md-4 col-sm-12">
										<input name="author" id="author" value="" placeholder="'.__('Nom','favethemes').'" type="text" class="form-control">
									</div>',
					...
					$comments_args = array(
						'fields' => $fields,
						'title_reply'=>'<h2 class="title"><span>'. __('Laisser un commentaire', 'favethemes') .'</span></h2>',
