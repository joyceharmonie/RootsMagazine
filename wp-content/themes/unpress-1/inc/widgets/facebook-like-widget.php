...
class Facebook_Like_Widget extends WP_Widget {
...

	{
		...
		$this->WP_Widget('facebook-like-widget', wf_theme_name().': Facebook Like Box', $widget_ops, $control_ops);
...

	{
		...
		<?php /*?><div class="b_sidebar_titles"><?php if($title) {echo $title;}?></div><?php */?>
...

	{
		...
		$defaults = array('title' => 'Find us on Facebook', 'page_url' => 'https://www.facebook.com/WfDigitalSolutions', 'width' => '280', 'color_scheme' => 'light', 'show_faces' => 'on', 'show_stream' => false, 'show_header' => false);
