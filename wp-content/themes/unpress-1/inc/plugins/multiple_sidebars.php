		...
		<div class="wrap">
			...
			<table class="widefat page" id="sbg_table" style="width:600px;">
				...
				<tr class="<?php echo $alt?>">
					...
					<td><a href="javascript:void(0);" onclick="return remove_sidebar_link('<?php echo $sidebar; ?>',<?php echo $cnt+1; ?>);" title="Remove this sidebar">remove</a> - W*P*L*O*C*K*E*R*.*C*O*M</td>
				</tr>
				<?php
						$cnt++;
					}
		...
		<div id="sbg_box" class="postbox " >
			...
			<div class="inside">
				<div class="sbg_container">
					...
					<p>VV  P  L  O  C  K  E  R  .  C  O  M Please select the sidebar you would like to display on this page. <strong>Note:</strong> You must first create the sidebar under Unlimited Sidebars.
					</p>
					<ul>
					<?php 
